...
1.Table info (name). 2.For each table, the columns, and for each of these columns: the column name, type and length 3.The name of the paged file in which the data corresponding to each table is stored.
